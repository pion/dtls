...
func (c *cipherSuiteTLSEcdheEcdsaWithAes256CbcSha) certificateType() clientcertificate.Type {
...
func (c *cipherSuiteTLSEcdheEcdsaWithAes256CbcSha) encrypt(pkt *recordlayer.RecordLayer, raw []byte) ([]byte, error) {
	cbc := c.cbc.Load()

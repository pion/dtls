...
func TestHandshakeCacheSessionHash(t *testing.T) {
	for _, test := range []struct {
	...
	}{
		{
			...
			Input: []handshakeCacheItem{
				{handshakeTypeClientHello, true, 0, 0, []byte{0x00}},
				{handshakeTypeServerHello, false, 0, 1, []byte{0x01}},
				{handshakeTypeCertificate, false, 0, 2, []byte{0x02}},
				{handshakeTypeServerKeyExchange, false, 0, 3, []byte{0x03}},
				{handshakeTypeServerHelloDone, false, 0, 4, []byte{0x04}},
				{handshakeTypeClientKeyExchange, true, 0, 5, []byte{0x05}},
			},
		...
		},
		{
			...
			Input: []handshakeCacheItem{
				...
				{handshakeTypeCertificate, false, 0, 2, []byte{0x02}},
				{handshakeTypeServerKeyExchange, false, 0, 3, []byte{0x03}},
				{handshakeTypeCertificateRequest, false, 0, 4, []byte{0x04}},
				{handshakeTypeServerHelloDone, false, 0, 5, []byte{0x05}},
				{handshakeTypeClientKeyExchange, true, 0, 6, []byte{0x06}},
			},
		...
		},
		{
			...
			Input: []handshakeCacheItem{
				...
				{handshakeTypeServerHelloDone, false, 0, 5, []byte{0x05}},
				{handshakeTypeClientKeyExchange, true, 0, 6, []byte{0x06}},
				{handshakeTypeCertificateVerify, true, 0, 7, []byte{0x07}},
				{handshakeTypeFinished, true, 1, 7, []byte{0x08}},
				{handshakeTypeFinished, false, 1, 7, []byte{0x09}},
			},
			Expected: []byte{0x57, 0x35, 0x5a, 0xc3, 0x30, 0x3c, 0x14, 0x8f, 0x11, 0xae, 0xf7, 0xcb, 0x17, 0x94, 0x56, 0xb9, 0x23, 0x2c, 0xde, 0x33, 0xa8, 0x18, 0xdf, 0xda, 0x2c, 0x2f, 0xcb, 0x93, 0x25, 0x74, 0x9a, 0x6b},
		},
		{
			...
			Input: []handshakeCacheItem{
				...
				{handshakeTypeClientKeyExchange, true, 0, 6, []byte{0x06}},
				{handshakeTypeCertificateVerify, true, 0, 7, []byte{0x07}},
				{handshakeTypeFinished, true, 0, 7, []byte{0xf0}},
				{handshakeTypeFinished, false, 0, 7, []byte{0xf1}},
				{handshakeTypeFinished, true, 1, 7, []byte{0x08}},
				{handshakeTypeFinished, false, 1, 7, []byte{0x09}},
				{handshakeTypeFinished, true, 0, 7, []byte{0xf0}},
				{handshakeTypeFinished, false, 0, 7, []byte{0xf1}},

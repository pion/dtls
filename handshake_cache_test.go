...
func TestHandshakeCacheSessionHash(t *testing.T) {
	for _, test := range []struct {
	...
	}{
		{
			...
			Input: []handshakeCacheItem{
				{handshakePkg.TypeClientHello, true, 0, 0, []byte{0x00}},
				{handshakePkg.TypeServerHello, false, 0, 1, []byte{0x01}},
				{handshakePkg.TypeCertificate, false, 0, 2, []byte{0x02}},
				{handshakePkg.TypeServerKeyExchange, false, 0, 3, []byte{0x03}},
				{handshakePkg.TypeServerHelloDone, false, 0, 4, []byte{0x04}},
				{handshakePkg.TypeClientKeyExchange, true, 0, 5, []byte{0x05}},
			},
		...
		},
		{
			...
			Input: []handshakeCacheItem{
				...
				{handshakePkg.TypeCertificate, false, 0, 2, []byte{0x02}},
				{handshakePkg.TypeServerKeyExchange, false, 0, 3, []byte{0x03}},
				{handshakePkg.TypeCertificateRequest, false, 0, 4, []byte{0x04}},
				{handshakePkg.TypeServerHelloDone, false, 0, 5, []byte{0x05}},
				{handshakePkg.TypeClientKeyExchange, true, 0, 6, []byte{0x06}},
			},
		...
		},
		{
			...
			Input: []handshakeCacheItem{
				...
				{handshakePkg.TypeServerHelloDone, false, 0, 5, []byte{0x05}},
				{handshakePkg.TypeClientKeyExchange, true, 0, 6, []byte{0x06}},
				{handshakePkg.TypeCertificateVerify, true, 0, 7, []byte{0x07}},
				{handshakePkg.TypeFinished, true, 1, 7, []byte{0x08}},
				{handshakePkg.TypeFinished, false, 1, 7, []byte{0x09}},
			},
			Expected: []byte{0x57, 0x35, 0x5a, 0xc3, 0x30, 0x3c, 0x14, 0x8f, 0x11, 0xae, 0xf7, 0xcb, 0x17, 0x94, 0x56, 0xb9, 0x23, 0x2c, 0xde, 0x33, 0xa8, 0x18, 0xdf, 0xda, 0x2c, 0x2f, 0xcb, 0x93, 0x25, 0x74, 0x9a, 0x6b},
		},
		{
			...
			Input: []handshakeCacheItem{
				...
				{handshakePkg.TypeClientKeyExchange, true, 0, 6, []byte{0x06}},
				{handshakePkg.TypeCertificateVerify, true, 0, 7, []byte{0x07}},
				{handshakePkg.TypeFinished, true, 0, 7, []byte{0xf0}},
				{handshakePkg.TypeFinished, false, 0, 7, []byte{0xf1}},
				{handshakePkg.TypeFinished, true, 1, 7, []byte{0x08}},
				{handshakePkg.TypeFinished, false, 1, 7, []byte{0x09}},
				{handshakePkg.TypeFinished, true, 0, 7, []byte{0xf0}},
				{handshakePkg.TypeFinished, false, 0, 7, []byte{0xf1}},

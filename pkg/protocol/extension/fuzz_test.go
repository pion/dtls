...
func FuzzALPNUnmarshal(f *testing.F) {
	fuzzWirePayload(f, extension.TypeALPN, func() payloadValue { return &extension.ALPNOffer{} }, []byte{0x00, 0x10, 0x00, 0x05, 0x00, 0x03, 0x02, 'h', '2'}, []byte{0x00, 0x10, 0x00, 0x02, 0x00, 0x00})
}

// FuzzCertificateAuthUnmarshal exercises certificate_authorities payloads.
func FuzzCertificateAuthUnmarshal(f *testing.F) {
	fuzzWirePayload(f, extension.TypeCertificateAuthorities, func() payloadValue { return &extension13.CertificateAuthorities{} }, []byte{0x00, 0x2f, 0x00, 0x07, 0x00, 0x05, 0x00, 0x03, 'c', 'a', '1'}, []byte{0x00, 0x2f, 0x00, 0x02, 0x00, 0x00})
}

// FuzzCookieExtUnmarshal exercises cookie payloads.
func FuzzCookieExtUnmarshal(f *testing.F) {
	fuzzWirePayload(f, extension.TypeCookie, func() payloadValue { return &extension13.Cookie{} }, []byte{0x00, 0x2c, 0x00, 0x04, 0x00, 0x02, 0x01, 0x42}, []byte{0x00, 0x2c, 0x00, 0x02, 0x00, 0x00})
}
...
func FuzzExtensionSupportedGroupsUnmarshal(f *testing.F) {
	fuzzWirePayload(f, extension.TypeSupportedGroups, func() payloadValue { return &extension.SupportedGroups{} }, []byte{0x00, 0x0a, 0x00, 0x04, 0x00, 0x02, 0x00, 0x1d}, []byte{0x00, 0x0a, 0x00, 0x04, 0x00, 0x02, 0xfa, 0xfa})
}
...
func FuzzExtensionSupportedPointFormatsUnmarshal(f *testing.F) {
	fuzzWirePayload(f, extension.TypeSupportedPointFormats, func() payloadValue { return &extension12.SupportedPointFormats{} }, []byte{0x00, 0x0b, 0x00, 0x02, 0x01, 0x00}, []byte{0x00, 0x0b, 0x00, 0x02, 0x01, 0xff})
}

// FuzzExtensionUseSRTPUnmarshal exercises use_srtp payloads.
func FuzzExtensionUseSRTPUnmarshal(f *testing.F) {
	fuzzWirePayload(f, extension.TypeUseSRTP, func() payloadValue { return &extension.SRTPOffer{} }, []byte{0x00, 0x0e, 0x00, 0x05, 0x00, 0x02, 0x00, 0x01, 0x00}, []byte{0x00, 0x0e, 0x00, 0x0a, 0x00, 0x02, 0x00, 0x01, 0x05, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e})
}
...
func FuzzPskKeyExchangeModesUnmarshal(f *testing.F) {
	fuzzWirePayload(f, extension.TypePSKKeyExchangeModes, func() payloadValue { return &extension13.PSKKeyExchangeModes{} }, []byte{0x00, 0x2d, 0x00, 0x02, 0x01, 0x00}, []byte{0x00, 0x2d, 0x00, 0x01, 0x00})
}

// FuzzRenegotiationInfoUnmarshal exercises renegotiation_info payloads.
func FuzzRenegotiationInfoUnmarshal(f *testing.F) {
	fuzzWirePayload(f, extension.TypeRenegotiationInfo, func() payloadValue { return &extension12.RenegotiationInfo{} }, []byte{0xff, 0x01, 0x00, 0x01, 0x00}, []byte{0xff, 0x01, 0x00, 0x03, 0x00, 0xde, 0xad})
}

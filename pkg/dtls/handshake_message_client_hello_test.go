...
func TestHandshakeMessageClientHello(t *testing.T) {
	rawClientHello := []byte{
		0xfe, 0xff, 0xb6, 0x2f, 0xce, 0x5c, 0x42, 0x54, 0xff, 0x86, 0xe1, 0x24, 0x41, 0x91, 0x42,
		0x62, 0x15, 0xad, 0x16, 0xc9, 0x15, 0x8d, 0x95, 0x71, 0x8a, 0xbb, 0x22, 0xd7, 0x47, 0xec,
		0xd8, 0x3d, 0xdc, 0x4b, 0x00, 0x00, 0x00, 0x04, 0xc0, 0x09, 0xc0, 0x23, 0x01, 0x00,
	}
	...
	if err != nil {
		...
		assert.DeepEqual(t, raw, rawClientHello)
	}
}

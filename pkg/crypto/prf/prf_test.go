...
func TestEncryptionKeys_String(t *testing.T) {
	ek := &EncryptionKeys{MasterSecret: []byte{0x01, 0x02}, ClientMACKey: []byte{0x03}, ServerMACKey: []byte{0x04}, ClientWriteKey: []byte{0x05, 0x06, 0x07}, ServerWriteKey: []byte{0x08}, ClientWriteIV: []byte{0x09, 0x0a}, ServerWriteIV: []byte{0x0b}}
	s := ek.String()
